...
export default function Home() {
  return (
    <div className="max-w-xl mx-auto bg-background p-6 rounded-lg shadow-md space-y-6">
      <h1 className="text-2xl font-bold">QR to Pay: Scan, Copy, Transfer!</h1>
      ...
      <ul className="list-disc pl-6">
        <li><b>Go to the <Link href="/create">Create QR page</Link> and enter your Details</b>: Pop in your bank account number, name, and any description (like &quot;Thanks for your support!&quot;).</li>
